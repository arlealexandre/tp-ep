...
The 2 different plot shows the average response time for the different scheduling disciplines for the G/G/k/FCFS queue and the G/G/1/FCFS queue with a server that operates at speed k. We can see that the average response time for the G/G/k/FCFS queue is always higher than the average response time for the G/G/1/FCFS queue with a server that operates at speed k. This is due to the fact that the G/G/k/FCFS queue has more servers and so the jobs are served faster.
