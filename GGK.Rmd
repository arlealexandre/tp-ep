...
```
Find the value of the ratio defined in the previous point in a limiting regime where the load approaches
one from below. Provide some intuition for the obtained value.
